    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8 gap-4">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white">{{ __('Payments') }}</h1>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Manage and track your payments</p>
                </div>
