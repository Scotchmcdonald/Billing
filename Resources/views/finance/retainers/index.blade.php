    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <form method="GET" action="{{ route('billing.finance.retainers') }}" class="bg-white shadow-sm rounded-lg p-6 mb-6">
            ...
            <div class="mt-4 flex justify-end space-x-3">
                <a href="{{ route('billing.finance.retainers') }}" class="px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
                    Clear
                </a>
