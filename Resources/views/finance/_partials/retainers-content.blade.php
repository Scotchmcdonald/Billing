<div class="space-y-6">
    <!-- Header -->
    <div>
        <h2 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Retainers</h2>
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Manage pre-paid hour blocks for clients</p>
    </div>
    ...
    @if($lowBalanceCount > 0)
        <div class="bg-warning-50 border-l-4 border-warning-400 p-4 rounded">
            <div class="flex">
                <div class="flex-shrink-0">
    ...
    <!-- Filters -->
    <form method="GET" action="{{ route('billing.finance.retainers') }}" class="bg-white shadow-sm rounded-lg p-6">
