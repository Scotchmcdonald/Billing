...
<form method="POST" action="{{ route('billing.finance.settings-hub.update') }}">
    @csrf
    <input type="hidden" name="integration" value="teams">
    <div class="space-y-4">
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Webhook URL</label>
            <input type="text" name="teams_webhook_url" value="{{ setting('teams_webhook_url') }}" 
            ...
            <p class="text-xs text-gray-500 mt-1">Incoming Webhook URL for your Teams channel</p>
        </div>
